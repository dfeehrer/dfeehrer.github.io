...
function type(){
	...
	.tiType("* ")
	.tiBreak()
	.tiType("* I have a set of solid fundamental CS skills, and an ability to dive into new projects and get things done.")
	.tiBreak()
	.tiType("* ")
	.tiBreak()
	.tiType("* I'm looking for a role with an innovative company, where I can grow as a developer.")
	.tiBreak()
	.tiType("* ")
	.tiBreak()
